...
set portList { 
	...
	{ s_relu_out_num_data_valid sc_in sc_lv 32 signal 1 } 
	{ s_relu_out_fifo_cap sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_relu_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s_relu_out", "role": "num_data_valid" }} , 
 	{ "name": "s_relu_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s_relu_out", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	...
	s_relu_out { ap_fifo {  { s_relu_out_din fifo_data_out 1 16 }  { s_relu_out_full_n fifo_status_empty 0 1 }  { s_relu_out_write fifo_data_in 1 1 }  { s_relu_out_num_data_valid fifo_update 0 32 }  { s_relu_out_fifo_cap fifo_data 0 32 } } }
}
