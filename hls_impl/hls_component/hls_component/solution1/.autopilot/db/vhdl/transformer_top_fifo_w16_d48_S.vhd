...
entity transformer_top_fifo_w16_d48_S is 
    generic (
...
architecture rtl of transformer_top_fifo_w16_d48_S is
...
------------------------Component----------------------
    component transformer_top_fifo_w16_d48_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 6;
        DEPTH      : integer := 48);
...
begin
----------------------- Instantiation -----------------------
    U_transformer_top_fifo_w16_d48_S_ShiftReg : transformer_top_fifo_w16_d48_S_ShiftReg
    generic map (
...
entity transformer_top_fifo_w16_d48_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 6;
        DEPTH      : integer := 48);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end transformer_top_fifo_w16_d48_S_ShiftReg;

architecture rtl of transformer_top_fifo_w16_d48_S_ShiftReg is
