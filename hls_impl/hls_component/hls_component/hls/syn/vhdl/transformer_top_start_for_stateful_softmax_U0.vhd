...
entity transformer_top_start_for_stateful_softmax_U0 is 
    generic (
...
architecture rtl of transformer_top_start_for_stateful_softmax_U0 is
...
------------------------Component----------------------
    component transformer_top_start_for_stateful_softmax_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_transformer_top_start_for_stateful_softmax_U0_ShiftReg : transformer_top_start_for_stateful_softmax_U0_ShiftReg
    generic map (
...
entity transformer_top_start_for_stateful_softmax_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end transformer_top_start_for_stateful_softmax_U0_ShiftReg;

architecture rtl of transformer_top_start_for_stateful_softmax_U0_ShiftReg is
