set moduleName stateful_softmax_Pipeline_VITIS_LOOP_188_1
set isTopModule 0
...
set cdfgNum 33
set C_modelName {stateful_softmax_Pipeline_VITIS_LOOP_188_1}
...
set C_modelArgList {
	...
	{ max_val_out int 8 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "s_gemm1_out", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_val_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_val_out sc_out sc_lv 8 signal 17 } 
	{ max_val_out_ap_vld sc_out sc_logic 1 outvld 17 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_val_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "max_val_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	max_val_out { ap_vld {  { max_val_out out_data 1 8 }  { max_val_out_ap_vld out_vld 1 1 } } }
}
