...
set portList { 
	...
	{ s_alu1_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ s_alu1_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set ArgLastReadFirstWriteLatency {
	alu_add_3 {
		...
		s_alu1 {Type O LastRead -1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	...
	s_alu1 { ap_fifo {  { s_alu1_din fifo_data_out 1 16 }  { s_alu1_full_n fifo_status_empty 0 1 }  { s_alu1_write fifo_data_in 1 1 }  { s_alu1_num_data_valid fifo_update 0 3 }  { s_alu1_fifo_cap fifo_data 0 3 } } }
}
